...
function index({ metaData, shopProducts, defaultProducts }) {
  return (
    <>
...
export const getServerSideProps = async () => {
  let url = APIURL() + "shop-page-details";
  ...
  url = APIURL() + "shop-top-feature-products/consumer";
  res = await axiosGet(url);
  const defaultProducts = res.data[0].response.data;

  return { props: { shopProducts: pageDetails, metaData, defaultProducts } };
};
