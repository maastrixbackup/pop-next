        ...
        <div className="buisness">
          ...
          <div className="body-box-margin">
            <MobileBanner
              ...
              page="landline-business"
              defaultProduct={product}
              theme="dark"
            />
            <Pricing bussinesspage={true} page="landline" type="business" />
            <Filter bussinesspage={true} type="business" page="landline" />
            <Experience
...
export const getServerSideProps = async () => {
    let url = APIURL() + "business-landline-page-details";
