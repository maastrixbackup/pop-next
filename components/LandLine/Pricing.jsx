...
// import animate from "../../images/animate.mp4";
...
function Pricing(props) {
  ...
  const saveInLocal = (e, data) => {
    ...
    localStorage.setItem(
      "upfrontPayment",
      data.upfront_price ? data.upfront_price : 0
    );
    ...
    localStorage.setItem(
      ...
      data.installation_cost
        ? data.installation_cost + data.upfront_price
        : data.upfront_price
    );
    ...
    <>
      <section>
        <div
          className={
            bussinesspage
              ? "price-expand-inner desktop_responsive container"
              : "price-expand-inner desktop_responsive"
          }
        >
          {product
            ? product.map((res, index) => (
                <div
                  className={bussinesspage ? "price-box col-lg-3" : "price-box"}
                  key={index}
                >
